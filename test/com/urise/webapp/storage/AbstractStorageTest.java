...
public abstract class AbstractStorageTest {
    ...
    protected static final String NAME_NEW = "nameNew";
    protected static final String NAME_DUMMY = "nameDummy";
    ...
    protected static final Resume RESUME_NEW = new Resume(UUID_NEW, NAME_NEW);
    protected static final Resume RESUME_DUMMY = new Resume(UUID_DUMMY, NAME_DUMMY);
    ...
    public void save() {
        ...
        Assert.assertEquals(RESUME_NEW, storage.get(UUID_NEW, NAME_NEW));
    }
    ...
    public void update() {
        ...
        Assert.assertEquals(updatedResume, storage.get(UUID_3, NAME_3));
    }
    ...
    @Test
    public void get() {
        Resume resume = storage.get(UUID_1, NAME_1);
        Assert.assertEquals(RESUME_1, resume);
    }

    @Test(expected = NotExistStorageException.class)
    public void getNotExist() {
        storage.get(UUID_DUMMY, NAME_DUMMY);
    }
}
